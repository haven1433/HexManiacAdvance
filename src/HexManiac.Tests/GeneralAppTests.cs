...
";
      ...
      public void CanSaveVersionToToml() {
         var metadata = new StoredMetadata(null, null, null, null, null, new StubMetadataInfo { VersionNumber = "0.1.0" }, default, default);
      ...
      public void NullVersionIsNotSavedToToml() {
         var metadata = new StoredMetadata(null, null, null, null, null, new StubMetadataInfo(), default, default);
         var lines = metadata.Serialize();
