...
namespace HavenSoft.HexManiac.WPF.Controls {
   ...
   /// </summary>
   public partial class AngleMenuItem {

      #region AngleDirection

      public static readonly DependencyProperty DirectionProperty = DependencyProperty.Register(nameof(Direction), typeof(AngleDirection), typeof(AngleMenuItem), new PropertyMetadata(AngleDirection.None));
      ...
      public static readonly DependencyProperty LeftTopProperty = DependencyProperty.Register(nameof(LeftTop), typeof(Point), typeof(AngleMenuItem), new PropertyMetadata(new Point(0, 0)));
      ...
      public static readonly DependencyProperty LeftMiddleProperty = DependencyProperty.Register(nameof(LeftMiddle), typeof(Point), typeof(AngleMenuItem), new PropertyMetadata(new Point(0, 5)));
      ...
      public static readonly DependencyProperty LeftBottomProperty = DependencyProperty.Register(nameof(LeftBottom), typeof(Point), typeof(AngleMenuItem), new PropertyMetadata(new Point(0, 10)));
      ...
      public static readonly DependencyProperty RightTopProperty = DependencyProperty.Register(nameof(RightTop), typeof(Point), typeof(AngleMenuItem), new PropertyMetadata(new Point(0, 0)));
      ...
      public static readonly DependencyProperty RightMiddleProperty = DependencyProperty.Register(nameof(RightMiddle), typeof(Point), typeof(AngleMenuItem), new PropertyMetadata(new Point(0, 5)));
      ...
      public static readonly DependencyProperty RightBottomProperty = DependencyProperty.Register(nameof(RightBottom), typeof(Point), typeof(AngleMenuItem), new PropertyMetadata(new Point(0, 10)));
      ...
      public AngleMenuItem() => InitializeComponent();
   }
}
